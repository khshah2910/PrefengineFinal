...
public class PreferenceController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getParameter("req1");
		request.getParameter("req2");
		System.out.println(request.getParameter("req1"));
		System.out.println(request.getParameter("req2"));
		System.out.println(request.getParameter("operator1"));
